        ...
        <div className="flex place-content-center gap-6 pt-1">
          <button onClick={() => setSelector("description")}>
            <svg
              ...
              className="icon icon-tabler icon-tabler-message-2 w-6 fill-[#626366] stroke-[#626366] dark:stroke-white hover:fill-lime-500 hover:stroke-lime-500 dark:fill-white hover:dark:fill-lime-500 hover:dark:stroke-lime-500"
              width="30"
              height="30"
              viewBox="0 0 24 24"
              strokeWidth="2"
          ...
          >
            ...
            >
              <path
                className="fill-[#626366] dark:fill-white hover:fill-fuchsia-400 hover:dark:fill-fuchsia-400"
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="icon icon-tabler icon-tabler-rocket w-6 fill-[#626366] stroke-[#626366] dark:stroke-black hover:fill-lime-500 hover:stroke-lime-500 dark:fill-white hover:dark:fill-lime-500 hover:dark:stroke-lime-500 hover:cursor-alias"
              width="30"
              height="30"
              viewBox="0 0 24 24"
              strokeWidth="2"
          ...
          <button onClick={() => setSelector("contributors")}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="icon icon-tabler icon-tabler-users-group w-6 stroke-[#626366] dark:stroke-white hover:stroke-pink-600 hover:dark:stroke-pink-600"
              width="30"
              height="30"
              viewBox="0 0 24 24"
              strokeWidth="2"
          ...
          <div className="flex-grow text-xs pt-2 mx-2">
            ...
            <div className="flex mt-4">
              {projectTechnologies[project_position].map((item) => (
                <p
                  key={item.tech}
                  className={`mx-1 font-semibold bg-[#d1d5db] dark:bg-[#23272f] ${item.color} px-2 py-0.5 rounded-full`}
                >
                  {item.tech}
                </p>
              ))}
